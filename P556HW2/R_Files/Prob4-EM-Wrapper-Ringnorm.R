...
cat("===== ===== ===== ===== ===== ===== \n")
cat("~ Running EM on Ringnorm Data\n", sep = "")
...
fileNameEM = paste(FolderPath, "Prob3-EM-SingleRun-Fast.R", sep = "")
...
if (controlInit) {
    errFileName = "Prob4_EMPCA_Ringnorm_ErrRes.RData"
    itrNumFileName = "Prob4_EMPCA_Ringnorm_ItrRes.RData"
