...
fileNameEM = paste(FolderPath, "ProbEC1-EM-SingleRun-Perturbed-kmeanspp.R", sep = "")
...
if (controlInit) {
    errFileName = "ProbEC1_EMkmeanspp_Ionosphere_ErrRes.RData"
    itrNumFileName = "ProbEC1_EMkmeanspp_Ionosphere_ItrRes.RData"
